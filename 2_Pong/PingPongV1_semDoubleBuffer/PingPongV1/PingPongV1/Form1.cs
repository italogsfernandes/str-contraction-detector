    ...
    public partial class Form1 : Form {
        ...
        private void Form1_Load(object sender, EventArgs e) {
            ...
            players[0] = new goleiro(
                new Point(25, panel1.Size.Height/2 - 50),
                new Point(50, panel1.Size.Height/2 + 50),
                new Pen(Color.Red,10),
                drawingGraphic, panel1.Size,true);
            players[1] = new goleiro(
                new Point(panel1.Size.Width - 50, panel1.Size.Height / 2 - 50),
                new Point(panel1.Size.Width - 25, panel1.Size.Height / 2 + 50),
        ...
        private void iniciar_campo() {
            foreach (goleiro jogador in players) {
                jogador.show();
            }
            main_bola.show();
        ...
        private void configuraçõesToolStripMenuItem_Click(object sender, EventArgs e) {
            drawingGraphic.DrawRectangle(new Pen(Color.Black, 5), 30, 30, 150, 150);
        }
