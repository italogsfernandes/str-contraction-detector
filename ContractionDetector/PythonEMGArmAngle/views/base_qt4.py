...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayoutChart1 = QtGui.QVBoxLayout()
        self.verticalLayoutChart1.setObjectName(_fromUtf8("verticalLayoutChart1"))
        self.replaceChart1 = QtGui.QPushButton(self.centralwidget)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.replaceChart1.sizePolicy().hasHeightForWidth())
        self.replaceChart1.setSizePolicy(sizePolicy)
        self.replaceChart1.setObjectName(_fromUtf8("replaceChart1"))
        self.verticalLayoutChart1.addWidget(self.replaceChart1)
        self.horizontalLayout_3.addLayout(self.verticalLayoutChart1)
        self.verticalLayoutChart2 = QtGui.QVBoxLayout()
        self.verticalLayoutChart2.setObjectName(_fromUtf8("verticalLayoutChart2"))
        self.replaceChart2 = QtGui.QPushButton(self.centralwidget)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.replaceChart2.sizePolicy().hasHeightForWidth())
        self.replaceChart2.setSizePolicy(sizePolicy)
        self.replaceChart2.setObjectName(_fromUtf8("replaceChart2"))
        self.verticalLayoutChart2.addWidget(self.replaceChart2)
        self.horizontalLayout_3.addLayout(self.verticalLayoutChart2)
        self.verticalLayoutGraphStatus.addLayout(self.horizontalLayout_3)
        self.horizontalLayout_2 = QtGui.QHBoxLayout()
        self.horizontalLayout_2.setObjectName(_fromUtf8("horizontalLayout_2"))
        self.verticalLayoutChart3 = QtGui.QVBoxLayout()
        self.verticalLayoutChart3.setObjectName(_fromUtf8("verticalLayoutChart3"))
        self.replaceChart3 = QtGui.QPushButton(self.centralwidget)
        self.replaceChart3.setObjectName(_fromUtf8("replaceChart3"))
        self.verticalLayoutChart3.addWidget(self.replaceChart3)
        self.horizontalLayout_2.addLayout(self.verticalLayoutChart3)
        self.verticalLayoutChart4 = QtGui.QVBoxLayout()
        self.verticalLayoutChart4.setObjectName(_fromUtf8("verticalLayoutChart4"))
        self.replaceChart4 = QtGui.QPushButton(self.centralwidget)
        self.replaceChart4.setObjectName(_fromUtf8("replaceChart4"))
        self.verticalLayoutChart4.addWidget(self.replaceChart4)
        self.horizontalLayout_2.addLayout(self.verticalLayoutChart4)
        self.verticalLayoutGraphStatus.addLayout(self.horizontalLayout_2)
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(_translate("MainWindow", "EMG Arm Angles", None))
        ...
        self.replaceChart1.setText(_translate("MainWindow", "PushButton", None))
        self.replaceChart2.setText(_translate("MainWindow", "PushButton", None))
        self.replaceChart3.setText(_translate("MainWindow", "PushButton", None))
        self.replaceChart4.setText(_translate("MainWindow", "PushButton", None))
